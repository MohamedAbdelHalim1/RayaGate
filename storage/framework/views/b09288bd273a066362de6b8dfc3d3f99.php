...
<body>
    ...
    <?php endif; ?>
     ...
     <div style="width:65%;margin:auto;margin-top:80px;">  
        <a href="<?php echo e(route('add_product')); ?>" class="btn btn-primary" style="float:right;">Add New Product</a>
        <h2>Products</h2> 
        <table class="table table-dark table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('more_details',$product->id)); ?>">Show</a> | <a href="<?php echo e(route('edit_product',$product->id)); ?>">Edit</a> | <a href="#" onclick="delete_product(<?php echo e($product->id); ?>)">Delete</a>
                    </td>
                </tr>
...
</html><?php /**PATH C:\rayaGateTask\resources\views/show_products.blade.php ENDPATH**/ ?>
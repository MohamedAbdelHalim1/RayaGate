...
<body>
    <nav class="navbar navbar-dark bg-dark">
        ...
        <form class="form-horizontal" action="<?php echo e(route('store_category')); ?>" method="post" style="width:65%;margin:auto;margin-top:80px;">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="checkbox"  name="product[]" value="<?php echo e($product->id); ?>">
...
</html><?php /**PATH C:\rayaGateTask\resources\views/category/add_category.blade.php ENDPATH**/ ?>
...
<body>
    <nav class="navbar navbar-dark bg-dark">
        ...
        <form class="form-horizontal" action="{{route('upload_product',$product->id)}}" method="post" style="width:65%;margin:auto;margin-top:80px;">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    @foreach($categories as $category)                       
                        <input type="checkbox"  name="category[]" value="{{$category->id}}" @if(in_array($category->id, $checked)) checked @endif  >
